    ...
    private class ExerciseDatabaseCallback(
        ...
        override fun onOpen(db: SupportSQLiteDatabase) {
            ...
            INSTANCE?.let { database ->
                scope.launch {
                    populateDatabase(database.exerciseDao(), database.workoutDao(), database.badgeDao(), database.loginDao(), database.userDao(), database.routineDao())
        ...
        suspend fun populateDatabase(exerciseDao: ExerciseDao, workoutDao:WorkoutDao, badgeDao:BadgeDao, loginDao: LoginDao, userDao: UserDao, routineDao: RoutineDao) {
